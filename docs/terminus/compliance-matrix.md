...
| TER-REQ-009 | No blind timing/Doppler search | Designed | ADR-0006; `spot_beams` (tags post-8, post-8b): residual budgets ±6 kHz (nadir spot, the Doppler worst case), ±60 µs (edge spot, the delay worst case) | — |
