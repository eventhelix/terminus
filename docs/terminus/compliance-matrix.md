...
| TER-REQ-009 | No blind timing/Doppler search | Designed | ADR-0006; `spot_beams` (tags post-8, post-8b, post-8c): residual budgets ±6 kHz (every spot alike — beam Doppler spread is the invariant (f/c)·v·β) and ±310 µs (the rim beam, whose elongated spot is farther, flatter, fatter: 5.3×) | — |
