...
| TER-REQ-008 | Cold start ≤15 min; reacquisition ≤30 s | Designed | ADR-0007; `first_contact` (tags post-9, post-9b): X-band lantern (aperture-set Doppler spread, v·k/D — same ±6 kHz as Ka from a 3.57° beam), 13.3 s raster, 43 s worst case, 21× margin; warm start in seconds, storm-proof via X | — |
